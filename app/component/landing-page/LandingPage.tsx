...
const LandingPage = () => {
  ...
  return (
    <div ref={ref} className="flex flex-col items-center font-[eczar]  text-white h-screen w-screen bg-[url('/backgroundcolorlandingpage.png')] bg-cover bg-center bg-no-repeat overflow-y-hidden">
      ...
      <div className=" md:text-[16px] xs:text-[10px] md:p-[20px] xs:p-[0px] font-bold md:mt-[34px] xs:mt-[0px]">FULLSTACK WEB DEVELOPER</div>
      <svg width="455" height="187" viewBox="0 0 455 157" fill="none" xmlns="http://www.w3.org/2000/svg" className=" md:mb-[10px]  md:w-[455px] xs:w-[255px] xs:my-[-30px] md:my-[0px]">
        <path
      ...
      <p className=" md:text-[17px] xs:text-[13px] md:w-[390px] xs:w-screen text-center md:mb-[57px] xs:mb-[10px] text-[#585858]">I’m an Indonesian Fullstack web developer, helping brands stand out in the digital era. Together, we’ll set new standards. No nonsense, always at the forefront of innovation.</p>
      <GsapMagnetic>
        <TranisitionLink href="/about" label="About me" className="md:w-[194px] xs:w-[100px] md:h-[38px] xs:h-[28px] flex items-center justify-center rounded-full bg-gradient-to-t from-[#181818] to-[#333333] text-[#a19f94] md:text-[20px] xs:text-[14px] font-bold" />
      </GsapMagnetic>
      <svg width="358" height="108" viewBox="0 0 358 108" fill="none" xmlns="http://www.w3.org/2000/svg" className=" md:mt-[30px] xs:mt-[5px] md:w-[358px] xs:w-[158px] frame-9 opacity-0">
